...
fun ImageProxy.imageProxyToBitmap(): Bitmap {
    ...
    return BitmapFactory.decodeByteArray(bytes, 0, bytes.size).rotateBitmapPhoto(this.imageInfo.rotationDegrees.toFloat())

}

fun Bitmap.rotateBitmapPhoto(postRotateDegrees: Float): Bitmap {

    val matrix = Matrix()
    matrix.postRotate(postRotateDegrees)
